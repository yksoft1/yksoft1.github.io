...
(function (Promise) {
  ...
  PC98DosBoxRunner.prototype.start = function () {
    FS.symlink('./emulator/pc98bios/FONT.ROM', '/FONT.ROM');
    FS.symlink('./emulator/pc98bios/2608_bd.wav', '/2608_bd.wav');
    FS.symlink('./emulator/pc98bios/2608_hh.wav', '/2608_hh.wav');
    FS.symlink('./emulator/pc98bios/2608_sd.wav', '/2608_sd.wav');
    FS.symlink('./emulator/pc98bios/2608_rim.wav', '/2608_rim.wav');
    FS.symlink('./emulator/pc98bios/2608_tom.wav', '/2608_tom.wav');
    FS.symlink('./emulator/pc98bios/2608_top.wav', '/2608_top.wav');
  }
  ...
  NP2Runner.prototype.start = function () {
	FS.symlink('./emulator/pc98bios/bios.rom', '/bios.rom');
    FS.symlink('./emulator/pc98bios/FONT.ROM', '/FONT.ROM');
    FS.symlink('./emulator/pc98bios/2608_bd.wav', '/2608_bd.wav');
    FS.symlink('./emulator/pc98bios/2608_hh.wav', '/2608_hh.wav');
    FS.symlink('./emulator/pc98bios/2608_sd.wav', '/2608_sd.wav');
    ...
    FS.symlink('./emulator/pc98bios/2608_tom.wav', '/2608_tom.wav');
    FS.symlink('./emulator/pc98bios/2608_top.wav', '/2608_top.wav');
	FS.symlink('./emulator/pc98bios/np2.cfg', '/np2.cfg');
  }
       ...
       loading.then(function (_game_data) {
              ...
              .then(function () {
                      ...
                      if ("runner" in game_data) {
                        if (game_data.runner == EmscriptenRunner || game_data.runner == MAMERunner || game_data.runner == PC98DosBoxRunner || game_data.runner == NP2Runner) {
